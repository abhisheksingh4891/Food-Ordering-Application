      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
          <ul className="navbar-nav fs-6 d-flex gap-3">
            ...
            <li className="nav-item">
              <Link className="nav-link active fw-bold " to="/cart">My Orders</Link>
            </li>
            <li className="nav-item">
              {isLogin ? (
            ...
            <li className="nav-item">
              <Link className="nav-link active fw-bold " to="/cart"><i className="fa fa-shopping-cart fs-3" aria-hidden="true"></i></Link>
            </li>
          </ul>
        </div>
      </div>
