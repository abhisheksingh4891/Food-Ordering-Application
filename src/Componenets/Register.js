            ...
            <div className="col-md-6 col-lg-10 d-flex align-items-center">
              <div className="card-body p-4 p-lg-5 text-black">
                ...
                <form>
                  ...
                  <h5 className="fw-normal mb-3 pb-1" style={{"letter-spacing": "1px;"}}><u>Sign Up into your account</u></h5>
                  
                  <div className="form-outline mb-4">
                    <label className="form-label text-black fw-bold" for="form2Example17">First Name</label>
                    <input type="email" id="form2Example17" className="form-control form-control-lg" />
                  </div>

                  <div className="form-outline mb-4">
                    <label className="form-label text-black fw-bold" for="form2Example17">Last Name</label>
                    <input type="email" id="form2Example17" className="form-control form-control-lg" />
                  </div>

                  <div className="form-outline mb-4">
                    <label className="form-label text-black fw-bold" for="form2Example17">Phone Number</label>
                    <input type="email" id="form2Example17" className="form-control form-control-lg" />
                  </div>
                  ...
                  <div className="form-outline mb-4">
                    <label className="form-label text-black fw-bold" for="form2Example27">Confirm Password</label>
                    <input type="password" id="form2Example27" className="form-control form-control-lg" />
                  </div>
                  ...
                  <p className="mb-2 text-black" style={{"color": "#393f81;"}}>Already have an account? <Link to="/login"
                      className="" style={{"color": "#393f81;"}}>Login here</Link></p>
